...
echo "$HOME/output/cime_run_dirs/${case_prefix}_${site_code}_ICB20TRCNPRDCTCBC/run"
echo " "
echo " "
cd $HOME/output/cime_run_dirs/${case_prefix}_${site_code}_ICB20TRCNPRDCTCBC/run
echo "**** Concatenating netCDF output - Hang tight this can take awhile ****"
ncrcat --ovr -h -H -C -x -v time_bounds *.h0.*.nc ELM_output.nc
chmod 775 ELM_output.nc
