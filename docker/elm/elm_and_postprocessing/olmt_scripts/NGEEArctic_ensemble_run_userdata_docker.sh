...
cp ${param_list} $HOME/output/cime_run_dirs/UQ/${case_prefix}_${site_code}_ICB20TRCNPRDCTCBC/.
### Collapse transient simulation output into a single netCDF file
echo " "
echo " "
echo " "
echo "**** Postprocessing ELM output in:"
echo "$HOME/output/cime_run_dirs/UQ/${case_prefix}_${site_code}_ICB20TRCNPRDCTCBC/"
echo " "
echo " "
cd $HOME/output/cime_run_dirs/UQ/${case_prefix}_${site_code}_ICB20TRCNPRDCTCBC/
echo " "
echo "**** Concatenating netCDF output - Hang tight this will take awhile ****"
echo ${PWD}
for d in */ ; do
    echo "Post-processing: $d"
    cd $HOME/output/cime_run_dirs/UQ/${case_prefix}_${site_code}_ICB20TRCNPRDCTCBC/${d}
