...
#export AMANZI_TPLS_DIR=$ATS_BASE/INSTALLED/amanzi-tpls/tpls-${TPLS_VERSION}-${TPLS_BUILD_TYPE}
...
#export AMANZI_DIR=${ATS_BASE}/INSTALLED/amanzi-ats/${ATS_BUILD_VERSION}-${ATS_BUILD_TYPE}
export AMANZI_DIR=$4
