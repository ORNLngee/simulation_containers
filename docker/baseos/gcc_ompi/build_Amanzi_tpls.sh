...
# ENVs for TPLs and/or amanzi/ats
export ATS_BASE=$1
export TPLS_VERSION=$2
export AMANZI_TPLS_DIR=$3
#export AMANZI_TPLS_DIR=$ATS_BASE/INSTALLED/amanzi-tpls-${TPLS_BUILD_TYPE}-${TPLS_VERSION}_${MPINAME}
...
export ATS_BUILD_VERSION=master
export AMANZI_TPLS_BUILD_DIR=$ATS_BASE/build/amanzi-tpls
export AMANZI_BUILD_DIR=$ATS_BASE/build/ats
export ATS_BUILD_DIR=$ATS_BASE/build/ats

export AMANZI_DIR=${ATS_BASE}/INSTALLED/amanzi-ats-${ATS_BUILD_TYPE}-${ATS_BUILD_VERSION}_${MPINAME}
